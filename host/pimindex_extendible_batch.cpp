...
void run_pimindex_extendible_batch(void* workload, uint32_t batch_keys, uint32_t insert_keys) {
    ...
    try {
        ...
        PRINT_TOP_RULE
        PRINT_INFO("PIM INDEX: Extendible Batch");
        PRINT_TOP_RULE
        ...
        uint32_t batch_insert_part_keys_offs = MAX_MRAM_SIZE;
        ...
        uint32_t batch_insert_keys_offs = MAX_MRAM_SIZE;
        ...
        uint32_t batch_search_part_keys_offs = MAX_MRAM_SIZE;
        ...
        uint32_t batch_search_keys_offs = MAX_MRAM_SIZE;
